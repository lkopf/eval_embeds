...
EXP_NAME="run_${RUN}"
OUT_BASE_DIR="${PWD}/symlinks/exp/semeval_2018_10/glove_300"
...
then
    ...
    EMBEDDINGS_H5PY="${PWD}/symlinks/exp/multi_sense_cooccur/linear_100/concat_with_glove_300/visual_word_vecs.h5py"
    WORD_TO_IDX_JSON="${PWD}/symlinks/exp/multi_sense_cooccur/linear_100/concat_with_glove_300/visual_word_vecs_idx.json"
    VISUAL_VOCAB_JSON="${PWD}/symlinks/exp/multi_sense_cooccur/linear_100/concat_with_glove_300/visual_words.json"
fi
